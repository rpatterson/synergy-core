...
public:
    ...
    void connectToServer_handleMessageReceived (const Event& /*e*/,
                                                void* /*unused*/);
    void sendMessageToServer_serverHandleMessageReceived (const Event& /*e*/,
                                                          void* /*unused*/);
    void sendMessageToClient_serverHandleClientConnected (const Event& /*e*/,
                                                          void* /*unused*/);
    void sendMessageToClient_clientHandleMessageReceived (const Event& /*e*/,
                                                          void* /*unused*/);
...
IpcTests::~IpcTests () = default;

void
IpcTests::connectToServer_handleMessageReceived (const Event& e,
                                                 void* /*unused*/) {
